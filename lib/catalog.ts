...
// Names: shortlist-sku!Página1 B5:C13, in sku-names.ts (20/09/2026).
// Marketing descriptions: shortlist-sku!Página1 B5:D13, with distinct risk disclosures in sku-copy.ts.
export const lines: {id:Line;name:string;path:string;verb:string;description:string;image:string}[] = [
  { id:'objetos', name:'Objetos & Colecionáveis', path:'/objetos-colecionaveis', verb:'Escolher', description:'Peças de catálogo para usar, exibir ou presentear — sem chaveiros nesta linha.', image:'/images/products/remix/G-ORG-RC-01_REMIX.webp' },
  { id:'datas', name:'Datas & Coleções', path:'/datas-colecoes', verb:'Celebrar', description:'Objetos e coleções para diferentes ocasiões, com composição e condições por produto.', image:'/images/products/remix/S-HAL-DEC-01_REMIX.webp' },
  ...
  { id:'chaveiros', name:'Chaveiros', path:'/chaveiros', verb:'Descobrir', description:'Chaveiros diversos, articulados e temáticos. Proposta de curadoria para negócios locais, ainda sem pontos parceiros confirmados.', image:'/images/products/remix/G-CHV-JJ-01_REMIX.webp' },
];
...
export const products: Product[] = [
 { ...fixture, id:'G-ORG-RC-01', slug:'g-org-rc-01', name:skuName('G-ORG-RC-01'), line:'objetos', kind:'Organização', price:79, image:'/images/products/remix/G-ORG-RC-01_REMIX.webp', gallery:['/images/products/remix/G-ORG-RC-01_REMIX.webp'], description:skuDescription('G-ORG-RC-01',renderNotice), dimensions:'Medidas finais pendentes de ficha técnica e protótipo.', includes:'1 organizador, proposta de unidade ainda não liberada. Controles não incluídos.', colors:['A validar'] },
 { ...fixture, id:'S-HAL-DEC-01', slug:'s-hal-dec-01', name:skuName('S-HAL-DEC-01'), line:'datas', kind:'Halloween', price:89, image:'/images/products/remix/S-HAL-DEC-01_REMIX.webp', gallery:['/images/products/remix/S-HAL-DEC-01_REMIX.webp','/images/products/remix/S-HAL-DEC-01_REMIX_02.webp','/images/products/remix/S-HAL-DEC-01_REMIX_03.webp','/images/products/remix/S-HAL-DEC-01_REMIX_04.webp'], description:skuDescription('S-HAL-DEC-01',renderNotice), dimensions:'A confirmar a partir do projeto e protótipo.', includes:'Conteúdo e quantidade de peças a confirmar. Doces e itens cenográficos não incluídos.', colors:['A validar'] },
 { ...fixture, id:'CAN-PET-001', slug:'can-pet-001', name:skuName('CAN-PET-001'), line:'feitos', kind:'Personalizados', price:249, image:'/images/pet.webp', description:skuDescription('CAN-PET-001',hi3dNotice), dimensions:'Dimensões a especificar e validar.', includes:'Escopo, revisão, referência, acabamento e unidade de venda a especificar.', colors:['A definir por oferta validada'] },
 { ...fixture, id:'G-VAS-ESC-01', slug:'g-vas-esc-01', name:skuName('G-VAS-ESC-01'), line:'objetos', kind:'Decoração', price:89, image:'/images/products/remix/G-VAS-ESC-01_REMIX.webp', gallery:['/images/products/remix/G-VAS-ESC-01_REMIX.webp'], description:skuDescription('G-VAS-ESC-01',renderNotice), dimensions:'A confirmar; geometria não equivale à prova de funcionalidade.', includes:'Composição e itens incluídos sujeitos a definição. Planta não incluída.', colors:['A validar'] },
 { ...fixture, id:'G-VAS-MIN-01', slug:'g-vas-min-01', name:skuName('G-VAS-MIN-01'), line:'objetos', kind:'Decoração', price:99, image:'/images/products/remix/G-VAS-MIN-01_REMIX.webp', gallery:['/images/products/remix/G-VAS-MIN-01_REMIX.webp'], description:skuDescription('G-VAS-MIN-01',renderNotice), dimensions:'A confirmar individualmente por componente.', includes:'Oferta pretendida: três mini-cachepots. Composição efetiva do arquivo e unidade final a validar; plantas não incluídas.', colors:['A validar'] },
 { ...fixture, id:'G-ORG-HS-01', slug:'g-org-hs-01', name:skuName('G-ORG-HS-01'), line:'objetos', kind:'Organização', price:69, image:'/images/products/remix/G-ORG-HS-01_REMIX.webp', gallery:['/images/products/remix/G-ORG-HS-01_REMIX.webp','/images/products/remix/G-ORG-HS-01_REMIX_02.webp','/images/products/remix/G-ORG-HS-01_REMIX_03.webp'], description:skuDescription('G-ORG-HS-01',renderNotice), dimensions:'A confirmar na ficha e em protótipo.', includes:'1 suporte proposto; headset não incluído.', colors:['A validar'] },
 { ...fixture, id:'G-CHV-JJ-01', slug:'g-chv-jj-01', name:skuName('G-CHV-JJ-01'), line:'chaveiros', kind:'Chaveiros', price:29, image:'/images/products/remix/G-CHV-JJ-01_REMIX.webp', gallery:['/images/products/remix/G-CHV-JJ-01_REMIX.webp','/images/products/remix/G-CHV-JJ-01_REMIX_02.webp','/images/products/remix/G-CHV-JJ-01_REMIX_03.webp'], description:skuDescription('G-CHV-JJ-01',renderNotice), dimensions:'A confirmar para a variante selecionada.', includes:'1 chaveiro proposto; argola, cores e acessórios ainda não especificados.', colors:['A validar'] },
 { ...fixture, id:'S-NAT-PRE-01', slug:'s-nat-pre-01', name:skuName('S-NAT-PRE-01'), line:'datas', kind:'Natal', price:89, image:'/images/products/remix/S-NAT-PRE-01_REMIX.webp', gallery:['/images/products/remix/S-NAT-PRE-01_REMIX.webp','/images/products/remix/S-NAT-PRE-01_REMIX_02.webp','/images/products/remix/S-NAT-PRE-01_REMIX_03.webp'], description:skuDescription('S-NAT-PRE-01',renderNotice), dimensions:'A confirmar na ficha e nos testes.', includes:'Composição a confirmar após identificação de componentes reais.', colors:['A validar'] },
 { ...fixture, id:'CAN-PESSOA-001', slug:'can-pessoa-001', name:skuName('CAN-PESSOA-001'), line:'feitos', kind:'Personalizados', price:299, image:'/images/person.webp', description:skuDescription('CAN-PESSOA-001',hi3dNotice), dimensions:'Dimensões ainda não validadas.', includes:'Escopo de referência, revisão, prévia e aprovação a especificar.', colors:['A definir por oferta validada'] },
];
...
export const faq=[
 ...
 ['As imagens são fotografias de peças prontas?','Os sete SKUs de catálogo usam imagens REMIX de suas respectivas pastas no Drive. São composições visuais editadas, sem comprovação de fotografia da peça fabricada. As duas ofertas personalizadas mantêm ilustrações conceituais. Amostras físicas, direitos e protótipos dependem de validação.'],
